        ...
        <section class="qr-card-panel" aria-label="${I18n.t("auth.qr.cardAriaLabel")}">
          <div class="qr-card">
            ...
            <div class="qr-actions">
              ...
              <button type="button" id="qr-email-btn" class="qr-action-btn qr-action-btn-secondary focusable" data-action="emailLogin">${I18n.t("auth.qr.emailLogin", {}, { fallback: "Email Login" })}</button>
